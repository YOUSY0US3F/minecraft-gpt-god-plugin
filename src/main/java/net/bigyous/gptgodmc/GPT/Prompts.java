...
public class Prompts {
    private static Map<GptGameMode, String> Prompts = Map.ofEntries(
        ...
        Map.entry(GptGameMode.DEATHMATCH, "You will roleplay as the god of a small minecraft world, the players are split into two teams that must fight to the death. Each team spawns on their own floating island and they need to build bridges between each other. You will decide which team to support based on which team aligns best with the reward / punish list.")
    );
